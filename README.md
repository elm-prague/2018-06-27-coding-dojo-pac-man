# ElmPrague Coding Dojo #5: Pac-Man

This repo shows [the end result](/tests/Tests.elm) of a Coding Dojo session.
We were implementing ["Pac-Man" kata](https://codingdojo.org/kata/PacMan/).
